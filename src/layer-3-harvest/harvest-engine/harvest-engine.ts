...
import type { SpineCandidate, SpineAssessmentInput, SpineResult, CompositionProposal, SpofAnalysis } from '../../layer-4-build-harden/product-spine/product-spine.js';
import type { SovereignDescriptor, SovereignReport } from '../sovereign-readiness/sovereign-readiness.js';
import type { BrandingElement, WhiteLabelReport } from '../../layer-4-build-harden/white-label/white-label.js';
