...
import { registerWriteTools, type WriteStores, type WriteRecord } from '../../layer-5-action/mcp-bridge/write-tools.js';
import { registerExternalTools, type ExternalSystems, type ExternalTarget } from '../../layer-5-action/mcp-bridge/external-tools.js';
