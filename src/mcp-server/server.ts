...
import { McpBridge, EXPOSED_READ_TOOLS, EXPOSED_DRAFT_TOOLS, EXPOSED_WRITE_TOOLS, EXPOSED_EXTERNAL_TOOLS } from '../layer-5-action/mcp-bridge/mcp-bridge.js';
...
import { RepoCreationGateway, TicketGateway, CrmGateway, EmailGateway, DeployGateway, MilestoneGateway, LabelGateway, IssueBatchGateway } from '../layer-5-action/external-gateways/external-gateways.js';
import { DecisionConsole } from '../layer-2-command/decision-console/decision-console.js';
...
import type { ExternalActionRequest } from '../layer-5-action/external-gateways/external-gateways.js';
