...
import { RepoCreationGateway, TicketGateway, CrmGateway, EmailGateway, DeployGateway, type ExternalActionRequest } from '../layer-5-action/external-gateways/external-gateways.js';
