...
import { registerExternalTools, registerForbiddenTools, MAX_ISSUE_BATCH, type ExternalSystems, type ExternalTarget } from '../features/mcp-bridge/external-tools.js';
import { MilestoneGateway, LabelGateway, IssueBatchGateway } from '../features/external-gateways/external-gateways.js';
