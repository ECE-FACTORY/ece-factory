...
const MODULE = path.join(REPO_ROOT, 'src/features/operator-cockpit/operator-cockpit.ts');
const ORCH = path.join(REPO_ROOT, 'src/features/operator-cockpit/venture-orchestrator.ts');
